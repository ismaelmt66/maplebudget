  ...
  return (
    ...
    >
        ...
        <div className="mb-container flex items-center justify-between gap-4 relative">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="leading-tight">
              <div className="font-bold text-lg tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-white/70">MapleBudget</div>
            </div>
          </Link>
      ...
      <QuickAddTransaction
        ...
        onSuccess={() => {
          window.dispatchEvent(new CustomEvent('maplebudget-tx-added'));
        }}
      />
    </header>
  );
