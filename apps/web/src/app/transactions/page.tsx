...
export default function TransactionsPage() {
  ...
  return (
    <main className="max-w-5xl mx-auto p-6">
      ...
      <p className="text-sm opacity-70 mt-1">MVP: catégories + transactions (FastAPI + SQLite)</p>
        ...
        <section className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="border rounded-xl p-4">
            ...
            <div className="mt-3 flex gap-2">
              ...
              <button className="border rounded-md px-3 py-2 text-sm" onClick={addCategory}>
                Ajouter
              </button>
            </div>
          ...
          <div className="border rounded-xl p-4">
            ...
            <div className="mt-3 grid gap-2 text-sm">
              ...
              <button className="border rounded-md px-3 py-2 mt-2" onClick={addTx}>
                Ajouter
              </button>
            </div>
